...
centrality_dict = nx.pagerank(H) # calculate page rank centrality
...
labels={'DONALD J. TRUMP': 'TRUMP', 'WILBUR ROSS': 'WILBUR', 'THRIVE CAPITAL': 'THRIVE', 'BETSY DEVOS': 'BETSY', 'ELAINE CHAO': 'ELAINE', '40 WALL STREET LLC': '40 WALL ST.', 'KUSHNER COMPANIES': 'KUSHNER CO.', 'TRUMP HOTELS & CASINO RESORTS, INC.': 'TRUMP HOTELS & CASINOS', 'JARED KUSHNER': 'JARED', 'DJT HOLDINGS LLC': 'DJT'}
